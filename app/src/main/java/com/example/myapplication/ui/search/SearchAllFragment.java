...
import com.example.myapplication.databinding.FragmentSearchAllBinding;
...
public class SearchAllFragment extends Fragment implements RecyclerViewInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (getSearchQuery.length() > 0) {
            ...
            if(searchModelListProduct != null) {
                ...
                productAdapter = new SearchAdapter(getActivity(), searchModelListProduct, SearchAllFragment.this, rv_search_products.getId());
                ...
                storeAdapter = new SearchAdapter(getActivity(), searchModelListStore, SearchAllFragment.this, rv_search_stores.getId());
...
//
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.length() > 0) {
                    ...
                    if(tempSearchModelListProduct != null) {
                        ll_search_products.setVisibility(View.VISIBLE);
                        productAdapter = new SearchAdapter(getActivity(), tempSearchModelListProduct, SearchAllFragment.this, rv_search_products.getId());
                        rv_search_products.setAdapter(productAdapter);
                        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
                        rv_search_products.setLayoutManager(layoutManager);
                        rv_search_products.setHasFixedSize(true);
                        ...
                        ll_search_stores.setVisibility(View.VISIBLE);
                        storeAdapter = new SearchAdapter(getActivity(), tempSearchModelListStore, SearchAllFragment.this, rv_search_stores.getId());
                        rv_search_stores.setAdapter(storeAdapter);
                        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
                        rv_search_stores.setLayoutManager(layoutManager);
                        rv_search_stores.setHasFixedSize(true);
    ...
    public void onItemClickSearch(int position, int recyclerViewId) {
        ...
        } else if (recyclerViewId == R.id.rv_search_products) {
